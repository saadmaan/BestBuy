	...
	<div class="container">
		...
		<section>
			<div class="container">
						...
						<div class="carousel slide" id="theCarousel" data-interval="2000">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img src="resources/similar1.jpg" alt="1" class="img-responsive" />
									<div class="carousel-caption"></div>
								</div>
								<div class="item">
									<img src="resources/v3.jpg" alt="2" class="img-responsive" />
									<div class="carousel-caption"></div>
								</div>
								<div class="item">
									<img src="resources/v2.jpg" alt="3"
										class="img-responsive" />
									<div class="carousel-caption"></div>
								</div>
								<div class="item active">
									<img src="resources/logo.jpg" alt="xyz" class="img-responsive" />
									<div class="carousel-caption"></div>
								</div>								
							</div>
				...
				<div id="well" class="well well-sm">
					<strong>Recommended Deals</strong>
				
				<div id="products" class="row list-group">
				<jsp:useBean id="random" class="java.util.Random" scope="application" />
				<% int j = random.nextInt(12); %>
				<c:set var="rand"><%= java.lang.Math.round(java.lang.Math.random() * 2) %></c:set>
					<c:forEach var="featProds" items="${featProd}" begin = "${random.nextInt(3) * 4}" end = "${13 -random.nextInt(3) * 4}">
						...
						<div class="item  col-xs-3 col-lg-4">
							<div class="thumbnail">
							<span class="label label-danger" >Best Deal</span>
								...
								<div class="caption">
									...
									<p class="group inner list-group-item-text">Recommended Deal for you.</p>
									<div class="row">
